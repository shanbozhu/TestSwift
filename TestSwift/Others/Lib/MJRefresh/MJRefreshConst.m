...
//NSString *const MJRefreshAutoFooterNoMoreDataText = @"暂无更多内容";
...
//NSString *const MJRefreshBackFooterNoMoreDataText = @"暂无更多内容";
NSString *const MJRefreshBackFooterNoMoreDataText = nil;
